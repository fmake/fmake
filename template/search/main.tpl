	...
	<!-- RIGHT -->
					...
					<div id="center" >
						...
						[[if pages>1]]
							...
							[[else]]
									<a href="/{request.modul}/page-{page-1}/[[if request.text_search]]text={request.text_search|url_encode}[[endif]]" class="black-submit">пред</a>
							[[endif]]
							[[if pages<=10]]
								[[set k1 = 1]]
								[[set k2 = pages]]
							...
							[[endif]]
							[[if k3==2 or k3==3]]
									<a href="/{request.modul}/page-1/[[if request.text_search]]text={request.text_search|url_encode}[[endif]]" class="black-submit">1</a>
									...
							[[endif]]
							...
							[[for i in k1 .. k2]]
								...
								[[else]]
									<a href="/{request.modul}/page-{i}/[[if request.text_search]]text={request.text_search|url_encode}[[endif]]" class="black-submit">{i}</a>
								[[endif]]
							[[endfor]]

							[[if k3==1 or k3==3]]
									...
									<a href="/{request.modul}/page-{pages}/[[if request.text_search]]text={request.text_search|url_encode}[[endif]]" class="black-submit">{pages}</a>
							[[endif]]
							
							[[if page==pages]]
								
							[[else]]
									<a href="/{request.modul}/page-{page+1}/[[if request.text_search]]text={request.text_search|url_encode}[[endif]]" class="black-submit">след</a>
							[[endif]]
						</div>
						[[endif]]
