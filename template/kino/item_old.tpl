	...
	<!-- RIGHT -->
					...
					<div id="center" >
						<div id="film-description" class="content-block">
							...
							<p>
								<a href="" class="show-film" onclick="return false;">Смотреть фильм онлайн</a>
							</p>
							<div id="video">
								<span id="video-content" class="video-hide">
									{compile(item.url_partners,_context)}
								</span>
								<div class="like">
										...
										<table>
											...
											<tr>
												...
												<td>
													...
													<!-- Введите код: <img src="/getpicture.php" alt="" /><input type="text" class="capcha"/> -->
												</td>
											</tr>
										</table>
									</form>
