	...
	<!-- <div class="actions" >
		<table class="rt" >
			...
			<tr>
				<td class="rt-ml"></td>
				<td class="rt-mc" >
					<a href="/admin/?modul={request.modul}&section=vopros&action=new" class="action-link" ><div><img src="/images/admin/and.png" alt="" /></div>Добавить вопрос</a>
					<a href="/admin/?modul={request.modul}&section=object&action=new" class="action-link" ><div><img src="/images/admin/and.png" alt="" /></div>Добавить объект</a>
				</td>
				<td class="rt-mr" ></td>
			</tr>
			<tr>
	...
	<tbody>
		[[for key,item in items]]
			...
			<td  
				...
				[[endif]]
				>[[if key=='caption']]
					<a href="/admin/?modul={request.modul}&id={item.id}&dop_polya=hide&action=edit">{item[key]}</a>
				[[else]]
					{item[key]}
				[[endif]]
				</td>	
