...
[[ macro childGenerateItem(item,actions,request) ]]
	<div>							
		...
		<a href="[[if item['delete_security']]]/admin/?modul={item.modul_redir}[[else]]/admin/?modul={request.modul}&id={item.id_genre}&action=edit[[endif]]" class="droppable_inner[[if item['delete_security']]] delete_security[[endif]]" >{item['caption']}</a>
		<div class="actions" >
...
[[ macro lineConstructor(item,actions,request) ]]
	<li class="droppable draggable" rel="id:{item['id_genre']};" >
