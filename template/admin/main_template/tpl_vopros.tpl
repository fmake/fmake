	...
	<div class="actions" >
		<table class="rt" >
			...
			<tr>
				<td class="rt-ml"></td>
				<td class="rt-mc" >
					[[if request.id_interview]]<a href="/admin/?modul={request.modul}&id_interview={request.id_interview}&action=new" class="action-link" ><div><img src="/images/admin/and.png" alt="" /></div>Добавить</a>[[endif]]
				</td>
				<td class="rt-mr" ></td>
			</tr>
			<tr>
