								...
								<td>
									...
									<div class="films-caption">
										[[for item in novinki]]
											<div class="item">
												<div class="left-zone">
													<a href="/kino/{item.id}/"><img width="120" src="/images/films/{item.id}/mini_image.jpg" alt="{item.caption}" /></a>
													[[raw]]
													<script>
														$(function(){  
															[[endraw]]
												...
												<div class="text">
													<a href="/kino/{item.id}/" class="film-caption">{item.caption}</a>
						...
						<div class="film-item content-block">
							<table><tr>
								<td class="left-film" width="100%" >
									...
									<p class="janr" ><span><a href="/kino/{item.id}/#comment" ><img src="/images/icon-comment.gif" /> Ваш отзыв</a></span>Жанр фильма: 
												...
												<div class="left-zone">
													...
													<script>
														$(function(){  
															...
															[[if item.star_read]]
															[[raw]]
																$('form#form_new[[endraw]]{item.id}[[raw]] :radio.star').rating([[endraw]][[if item.star_count]]'select',{item.star_count-1}[[endif]][[raw]]);
																$('form#form_new[[endraw]]{item.id}[[raw]] :radio.star').rating('readOnly',true);
															[[endraw]]
															[[else]]
															[[raw]]
																$('form#form_new[[endraw]]{item.id}[[raw]] :radio.star').rating([[endraw]][[if item.star_count]]'select',{item.star_count-1}[[endif]][[raw]]);
																$('form#form_new[[endraw]]{item.id}[[raw]] :radio.star').rating('readOnly',false);
															[[endraw]]
															[[endif]]
															[[raw]]
															$('.star-rating').live('click',function(){
