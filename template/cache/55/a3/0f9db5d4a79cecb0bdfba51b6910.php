...
/* kino/main.tpl */
class __TwigTemplate_55a30f9db5d4a79cecb0bdfba51b6910 extends Twig_Template
{
    protected $parent;
...
\t\t\t\t\t\t\t\t\t<p class=\"janr\" ><span><a href=\"/";
            ...
            echo "/#comment\" ><img src=\"/images/icon-comment.gif\" /> Ваш отзыв</a></span>
\t\t\t\t\t\t\t\t\t";
            // line 18
...
\t\t\t\t\t\t\t\t\t<a href=\"/";
            ...
            echo "/#view-online\" class=\"black-submit\" title=\"Смотреть онлайн\">СМОТРЕТЬ ОНЛАЙН</a>
\t\t\t\t\t\t\t\t\t<a href=\"/";
            // line 42
            ...
            echo "/#view-online\" class=\"orange-submit\" title=\"Скачать\" >СКАЧАТЬ</a>
\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t<td class=\"right-film\">
\t\t\t\t\t\t\t\t\t\t<a href=\"/";
            // line 45
...
\t\t\t\t\t\t\t";
                ...
                // line 94
                echo "\t\t\t\t\t\t\t\t\t<a href=\"/";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context['request']) ? $context['request'] : null), "modul", array(), "any", false, 94), "html");
                echo "/page-";
...
\t\t\t\t\t\t\t";
            ...
            if ((((isset($context['k3']) ? $context['k3'] : null) == 2) || ((isset($context['k3']) ? $context['k3'] : null) == 3))) {
                // line 115
                echo "\t\t\t\t\t\t\t\t\t<a href=\"/";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context['request']) ? $context['request'] : null), "modul", array(), "any", false, 115), "html");
...
\t\t\t\t\t\t\t\t";
                    ...
                    // line 123
                    echo "\t\t\t\t\t\t\t\t\t<a href=\"/";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context['request']) ? $context['request'] : null), "modul", array(), "any", false, 123), "html");
                    echo "/page-";
                    echo twig_escape_filter($this->env, (isset($context['i']) ? $context['i'] : null), "html");
...
\t\t\t\t\t\t\t\t\t<a href=\"/";
                // line 129
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context['request']) ? $context['request'] : null), "modul", array(), "any", false, 129), "html");
                echo "/page-";
...
\t\t\t\t\t\t\t";
                ...
                // line 135
                echo "\t\t\t\t\t\t\t\t\t<a href=\"/";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context['request']) ? $context['request'] : null), "modul", array(), "any", false, 135), "html");
                echo "/page-";
                echo twig_escape_filter($this->env, ((isset($context['page']) ? $context['page'] : null) + 1), "html");
